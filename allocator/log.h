 ...
 */
  ...
  * @subsection step1 STEP 1:either use make compile(which run the production versiion) or make debug which runs the debug version.
  * @subsection step2 STEP 2: run ./main to load the program into the main memory.
  * 
  */
#ifndef LOG_H
	#define LOG_H
